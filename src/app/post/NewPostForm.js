        ...
        <div className="flex space-x-4">
          ...
          <Dialog open={isPostFormOpen} onOpenChange={setPostForm}>
            ...
            <DialogContent className="sm:max-w-[525px] max-h-[80vh] dark:bg-[#202023] overflow-y-auto">
              ...
              <AnimatePresence>
                {filePreview && (
                  <motion.div
                    ...
                    className="relative mt-4 border-2 border-dashed p-8 justify-center items-center flex flex-col rounded-lg"
                  >
                    <Button variant="ghost" size="icon" className="absolute top-2 right-2" onClick={handleRemoveFile}>
                      <X className="w-4 h-4" />
                    </Button>
                    {fileType.startsWith('image') ? (
                      <img src={filePreview} alt="Preview" className="rounded-lg max-h-[300px]" />
                    ) : (
                      <video src={filePreview} controls className="rounded-lg max-h-[300px]" />
                    )}
                  </motion.div>
                )}
              </AnimatePresence>
              ...
              {!filePreview && (
                <div className="relative mt-4 border-2 border-dashed p-8 justify-center items-center flex flex-col rounded-lg">
                  <Plus className="h-12 w-12 text-gray-500 cursor-pointer" />
                  <p className="text-gray-700 text-center">Add Photos/Videos</p>
                  <input
                    type="file"
              ...
              <div className="flex justify-end mt-4">
                <Button className="bg-blue-500 text-white cursor-pointer">POST</Button>
              </div>
            </DialogContent>
          </Dialog>
        </div>
